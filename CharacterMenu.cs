...
public class CharacterMenu : MonoBehaviour
{
    ...
    private void OnSelectionChanged() 
    {
        ...
        switch (currentCharacterSelection)
        {
            case 1:
                ...
                GameManager.instance.player.maxHitPoint += 2;
                break;
            case 2:
            ...
            case 3:
                ...
                GameManager.instance.player.maxHitPoint += 4;
            ...
            case 4:
                ...
                GameManager.instance.player.maxHitPoint += 5;
            ...
            case 5:
                ...
                GameManager.instance.player.maxHitPoint += 6;
    ...
    {
        //hero
        characterSelectionSprite.sprite = GameManager.instance.playerSprites[GameManager.instance.skin];
